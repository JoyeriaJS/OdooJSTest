    ...
    async add_product(product, options = {}) {
        ...
        if (product.name === "Producto GASTO") {
            ...
            const nombre = await popup.add(TextInputPopup, {
                ...
                placeholder: "Ej: Bolsa, Taxi",
            });

            if (!nombre.confirmed || !nombre.payload.trim()) {
                await popup.add(ErrorPopup, {
                    title: "Dato obligatorio",
        ...
        if (product.name === "Producto RMA") {
            ...
            const productoAbono = allProducts.find(
                (p) => p.name === "Producto ABONO"
            );

            if (!productoSubtotal || !productoAbono) {
                await popup.add(ErrorPopup, {
                    title: "Error de configuración",
                    body: 'Debes tener "Producto SUBTOTAL" y "Producto ABONO".',
                });
                return;
            }
            ...
            if (lineSubtotal) {
                ...
                lineSubtotal.set_unit_price(subtotal);
            }
            ...
            if (lineAbono) {
                ...
                // 👇 IMPORTANTE
                lineAbono.es_linea_visual = true;
                ...
                lineAbono.set_unit_price(abono);
            }
...
patch(Orderline.prototype, {
    ...
    // ===================================
    // NO SUMAR LÍNEAS VISUALES
    // ===================================
    get_display_price() {

        if (this.es_linea_visual) {
            return 0;
        }
    ...
    set_unit_price(price) {
        ...
        if (this.es_linea_rma_principal) {
            ...
            if (price !== 0) {
                ...
                popup.add(ErrorPopup, {
                    title: "Acción no permitida",
                    body: "No se puede modificar Producto RMA.",
                });
        ...
        if (this.tipo_linea_rma === "subtotal") {
            ...
            const precioBloqueado =
                this.precio_bloqueado ?? this.get_unit_price();
    ...
    export_as_JSON() {
        ...
        json.es_linea_rma_principal =
            this.es_linea_rma_principal || false;

        json.es_linea_rma_aux =
        ...
        json.es_linea_visual =
            this.es_linea_visual || false;
    ...
    init_from_JSON(json) {
        ...
        this.es_linea_rma_principal =
            json.es_linea_rma_principal || false;

        this.es_linea_rma_aux =
            json.es_linea_rma_aux || false;
        ...
        this.es_linea_visual =
            json.es_linea_visual || false;
