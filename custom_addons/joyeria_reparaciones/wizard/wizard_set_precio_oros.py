...
class WizardSetPrecioOros(models.TransientModel):
    ...
    price_amarillo = fields.Float('Precio Oro Amarillo 18k', required=True, default=160000.0)
    precio_rosado = fields.Float('Precio Oro Rosado 18k', required=True, default=150000.0)
    ...
    def action_print_report(self):
        ...
        return self.env.ref('joyeria_reparaciones.action_report_sales_by_store').report_action(
            self, data={
                'price_amarillo': self.price_amarillo,
                'price_rosado': self.precio_rosado,
