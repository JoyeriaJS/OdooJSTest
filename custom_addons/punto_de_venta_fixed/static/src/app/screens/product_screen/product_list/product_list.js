...
import { ProductCard } from "@punto_de_venta/app/generic_components/product_card/product_card";
import { Component, useState, useEffect, useRef } from "@odoo/owl";
import { OfflineErrorPopup } from "@punto_de_venta/app/errors/popups/offline_error_popup";
import { ErrorPopup } from "@punto_de_venta/app/errors/popups/error_popup";
import { ProductInfoPopup } from "@punto_de_venta/app/screens/product_screen/product_info_popup/product_info_popup";
import { CategorySelector } from "@punto_de_venta/app/generic_components/category_selector/category_selector";
...
export class ProductsWidget extends Component {
    ...
    static template = "punto_de_venta.ProductsWidget";
    setup() {
        this.state = useState({
            previousSearchWord: "",
            currentOffset: 0,
    ...
    /**
     * @returns {import("@punto_de_venta/app/generic_components/category_selector/category_selector").Category[]}
     */
    getCategories() {
        return [
    ...
    createNewProducts() {
        window.open("/web#action=punto_de_venta.action_client_product_menu", "_self");
    }
