...
import { constructFullProductName, random5Chars, uuidv4, qrCodeSrc } from "@punto_de_venta/utils";
...
import { ProductConfiguratorPopup } from "@punto_de_venta/app/store/product_configurator_popup/product_configurator_popup";
...
export class Order extends PosModel {
    ...
    export_for_printing() {
        ...
        return {
            ...
            pos_qr_code:
                this.pos.company.punto_de_venta_use_ticket_qr_code &&
            ...
            ticket_code:
                this.pos.company.punto_de_venta_ticket_unique_code &&
                this.finalized &&
                this.ticketCode,
    ...
    async printChanges(cancelled) {
        ...
        for (const printer of this.pos.unwatched.printers) {
            ...
            if (changes["new"].length > 0 || changes["cancelled"].length > 0) {
                ...
                const receipt = renderToElement("punto_de_venta.OrderChangeReceipt", {
