...
class ResConfigSettings(models.TransientModel):
    ...
    update_stock_quantities = fields.Selection(related="company_id.punto_de_venta_update_stock_quantities", readonly=False)
    ...
    punto_de_venta_use_ticket_qr_code = fields.Boolean(related='company_id.punto_de_venta_use_ticket_qr_code', readonly=False)
    ...
    punto_de_venta_ticket_unique_code = fields.Boolean(related='company_id.punto_de_venta_ticket_unique_code', readonly=False)
