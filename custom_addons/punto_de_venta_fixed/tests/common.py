...
def archive_products(env):
    ...
    discount = env.ref('punto_de_venta.product_product_consumable')
    tip = env.ref('punto_de_venta.product_product_tip')
...
class TestPointOfSaleCommon(ValuationReconciliationTestCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.company_data['company'].write({
            'punto_de_venta_update_stock_quantities': 'real',
        })
...
class TestPoSCommon(ValuationReconciliationTestCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        # basic_config
        #   - derived from 'punto_de_venta.pos_config_main' with added invoice_journal_id and credit payment method.
