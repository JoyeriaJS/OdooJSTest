...
class TestReportSession(TestPoSCommon):
    ...
    def test_report_session(self):
        ...
        report = self.env['report.punto_de_venta.report_saledetails'].get_sale_details(session_ids=[session_id])
    ...
    def test_report_session_2(self):
        ...
        report = self.env['report.punto_de_venta.report_saledetails'].get_sale_details()
