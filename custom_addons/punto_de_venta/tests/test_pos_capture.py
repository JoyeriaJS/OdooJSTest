...
import odoo
from odoo.addons.punto_de_venta.models.pos_order import PosOrder
from odoo.addons.punto_de_venta.models.pos_session import PosSession
from odoo.addons.punto_de_venta.tests.common import TestPoSCommon
...
class TestPosCapture(TestPoSCommon):
    ...
    def test_capture_one_order(self):
        ...
        with patch.object(PosOrder, '_process_order', mocked_process_order),\
             ...
             self.assertLogs('odoo.addons.punto_de_venta.models.pos_order', level=logging.ERROR) as logger_error_output:
            try:
    ...
    def test_capture_two_orders(self):
        ...
        with patch.object(PosOrder, '_process_order', mocked_process_order),\
             patch.object(PosSession, '_handle_order_process_fail', mocked_handle_order_process_fail),\
             self.assertLogs('odoo.addons.punto_de_venta.models.pos_order', level=logging.ERROR):
            try:
