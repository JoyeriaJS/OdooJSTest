...
from odoo.addons.punto_de_venta.tests.common import TestPointOfSaleCommon
...
class TestPointOfSaleFlow(TestPointOfSaleCommon):
    ...
    def test_create_from_ui(self):
        ...
        with mute_logger('odoo.addons.punto_de_venta.models.pos_order'):
    ...
    def test_sale_order_postponed_invoicing_anglosaxon(self):
        ...
        self.env.company.punto_de_venta_update_stock_quantities = 'closing'
        pos_order = self._create_pos_order_for_postponed_invoicing()
    ...
    def test_order_total_subtotal_account_line_values(self):
        ...
        pos_user = self.env['res.users'].create({
            ...
            'groups_id': [(6, 0, [self.ref('base.group_user'), self.ref('punto_de_venta.group_pos_user')])],
        })
