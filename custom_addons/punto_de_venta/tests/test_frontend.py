...
from odoo.addons.punto_de_venta.tests.common_setup_methods import setup_pos_combo_items
from datetime import date, timedelta
from odoo.addons.punto_de_venta.tests.common import archive_products
from odoo.addons.punto_de_venta.models.pos_config import PosConfig
...
class TestPointOfSaleHttpCommon(AccountTestInvoicingHttpCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        env = cls.env
        cls.env.user.groups_id += env.ref('punto_de_venta.group_pos_manager')
        ...
        cls.pos_user = cls.env['res.users'].create({
            ...
            'groups_id': [
                ...
                (4, cls.env.ref('punto_de_venta.group_pos_user').id),
            ],
        })
        ...
        cls.pos_admin = cls.env['res.users'].create({
            ...
            'password': 'pos_admin',
            'groups_id': [
                (4, cls.env.ref('punto_de_venta.group_pos_manager').id),
            ],
        })
        ...
        cls.tip = env.ref('punto_de_venta.product_product_tip')
        ...
        env['product.pricelist'].create({
            ...
            'item_ids': [(0, 0, {
                ...
                'applied_on': '0_product_variant',
                'min_quantity': 2,
                'product_id': env.ref('punto_de_venta.product_product_consumable').id,
            })],
        })
...
class TestUi(TestPointOfSaleHttpCommon):
    def test_01_pos_basic_order(self):
        ...
        self.env['ir.module.module'].search([('name', '=', 'punto_de_venta')], limit=1).state = 'installed'
    ...
    def test_07_pos_barcodes_scan(self):
        barcode_rule = self.env.ref("punto_de_venta.barcode_rule_client")
        ...
        self.env.user.write({'groups_id': [
            Command.set(
                [
                    ...
                    self.env.ref('punto_de_venta.group_pos_user').id,
                ]
            )
        ]})
        self.main_pos_config.open_ui()
    ...
    def test_limited_product_pricelist_loading(self):
        self.env['ir.config_parameter'].sudo().set_param('punto_de_venta.limited_product_count', '1')
