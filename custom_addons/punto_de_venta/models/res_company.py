...
class ResCompany(models.Model):
    ...
    punto_de_venta_update_stock_quantities = fields.Selection([
    ...
    punto_de_venta_use_ticket_qr_code = fields.Boolean(
    ...
    punto_de_venta_ticket_unique_code = fields.Boolean(
