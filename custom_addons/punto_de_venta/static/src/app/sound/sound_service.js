...
registry
    .category("sounds")
    .add("error", "/punto_de_venta/static/src/sounds/error.wav")
    .add("bell", "/punto_de_venta/static/src/sounds/bell.wav")
    .add("notification", "/punto_de_venta/static/src/sounds/notification.wav");
