...
import { PosCollection, Order, Product } from "@punto_de_venta/app/store/models";
import { Mutex } from "@web/core/utils/concurrency";
import { PosDB } from "@punto_de_venta/app/store/db";
...
import { deduceUrl } from "@punto_de_venta/utils";
import { Reactive } from "@web/core/utils/reactive";
import { HWPrinter } from "@punto_de_venta/app/printer/hw_printer";
import { memoize } from "@web/core/utils/functions";
import { ErrorPopup } from "@punto_de_venta/app/errors/popups/error_popup";
import { ConnectionLostError, RPCError } from "@web/core/network/rpc_service";
import { _t } from "@web/core/l10n/translation";
import { CashOpeningPopup } from "@punto_de_venta/app/store/cash_opening_popup/cash_opening_popup";
import { PaymentScreen } from "@punto_de_venta/app/screens/payment_screen/payment_screen";
...
export class PosStore extends Reactive {
    ...
    async customerDisplayHTML(closeUI = false) {
        const order = this.get_order();
        if (closeUI || !order) {
            return renderToString("punto_de_venta.CustomerFacingDisplayNoOrder", {
                pos: this,
        ...
        return renderToString("punto_de_venta.CustomerFacingDisplayOrder", {
            pos: this,
    ...
    redirectToBackend() {
        window.location = "/web#action=punto_de_venta.action_client_pos_menu";
    }
