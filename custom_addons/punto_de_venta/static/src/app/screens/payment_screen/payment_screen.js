...
import { useErrorHandlers, useAsyncLockedMethod } from "@punto_de_venta/app/utils/hooks";
...
import { DatePickerPopup } from "@punto_de_venta/app/utils/date_picker_popup/date_picker_popup";
import { ConfirmPopup } from "@punto_de_venta/app/utils/confirm_popup/confirm_popup";
import { ConnectionLostError } from "@web/core/network/rpc_service";

import { PaymentScreenPaymentLines } from "@punto_de_venta/app/screens/payment_screen/payment_lines/payment_lines";
import { PaymentScreenStatus } from "@punto_de_venta/app/screens/payment_screen/payment_status/payment_status";
...
export class PaymentScreen extends Component {
    static template = "punto_de_venta.PaymentScreen";
    static components = {
        Numpad,
    ...
    paymentMethodImage(id) {
        if (this.paymentMethod.image) {
            ...
            return "/punto_de_venta/static/src/img/money.png";
        } else if (this.paymentMethod.type === "pay_later") {
            return "/punto_de_venta/static/src/img/pay-later.png";
        } else {
            return "/punto_de_venta/static/src/img/card-bank.png";
        }
    }
