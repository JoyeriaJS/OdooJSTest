...

{
    ...
    'data': [
        'security/punto_de_venta_security.xml',
        ...
        'views/punto_de_venta_report.xml',
        'views/punto_de_venta_view.xml',
        ...
        'views/punto_de_venta_sequence.xml',
        'data/punto_de_venta_data.xml',
        ...
        'views/punto_de_venta_dashboard.xml',
    ...
    'demo': [
        'data/punto_de_venta_demo.xml',
    ],
    'installable': True,
    'application': True,
    'website': 'https://www.odoo.com/app/punto-de-venta-shop',
    'assets': {
        ...
        # web assets
        'web.assets_backend': [
            'punto_de_venta/static/src/scss/pos_dashboard.scss',
            'punto_de_venta/static/src/backend/tours/punto_de_venta.js',
            'punto_de_venta/static/src/backend/debug_manager.js',
        ],
        'web.assets_tests': [
            'barcodes/static/tests/helpers.js',
            'punto_de_venta/static/tests/tours/**/*',
        ],

        # PoS assets

        # Main PoS assets, they are loaded in the PoS UI and in the PoS unit tests
        'punto_de_venta._assets_pos': [
            # 'preparation_display' bootstrap customization layer
            'web/static/src/scss/functions.scss',
            # 'punto_de_venta/static/src/scss/primary_variables.scss', TO DO - CREATE
            ...
            'punto_de_venta/static/src/scss/pos_variables_extra.scss',
            ...
            # PoS files
            'punto_de_venta/static/src/**/*',
            ('remove', 'punto_de_venta/static/src/backend/**/*'),
            # main.js boots the pos app, it is only included in the prod bundle as tests mount the app themselves
            ('remove', 'punto_de_venta/static/src/app/main.js'),
        ...
        'punto_de_venta.assets_prod': [
            ('include', 'punto_de_venta._assets_pos'),
            'punto_de_venta/static/src/app/main.js',
        ],
        # Bundle for the unit tests at /pos/ui/tests
        'punto_de_venta.assets_qunit_tests': [
            ('include', 'punto_de_venta._assets_pos'),
            ...
            # pos unit tests
            'punto_de_venta/static/tests/unit/**/*',
        ],
    },
    'license': 'LGPL-3',
}
